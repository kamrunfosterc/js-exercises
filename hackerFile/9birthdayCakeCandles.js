...
//todo Solution function
function birthdayCakeCandles(candles) {
    // pull tallest number & count how many times it happens
    let tall = Math.max(...candles); //finds largest value in array
    let tallSum = 0;// placeholder value
    console.log("The tallest candle is: " + tall);
    ...
    console.log(tall + " is returned " + tallSum + " times!");
    return tallSum;
}
