...
//        to stdout using System.out.println(String). So, if our input is:
//
//        Hi 5
//        Our code will print:
//
...
public class in_output_scanner_2 {
    public class Solution {

        public static void main(String[] args) {
            Scanner scan = new Scanner(System.in);//creates variable to take input from user
            int a = scan.nextInt();//looks for 1st value as int a
            int b = scan.nextInt();//looks for 1st value as int b
            int c = scan.nextInt();//looks for 1st value as int c

            System.out.println(a);//displays value a
            System.out.println(b);//displays value b
            System.out.println(c);//displays value c
        }
    }
}
